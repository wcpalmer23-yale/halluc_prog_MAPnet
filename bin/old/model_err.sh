...
for i in $(seq ${start_iter} ${end_iter}); do
    ...
    if [[ ${i} == 0 ]] && [[ -f ${proj_dir}/images/baseline/baseline_classif.pt ]]; then
        ...
        mkdir ${proj_dir}/images/${nmodel}_0/
        cp ${proj_dir}/images/baseline/baseline_alpha.txt ${proj_dir}/images/${nmodel}_0/${nmodel}_0_alpha.txt
        cp ${proj_dir}/images/baseline/baseline_classif.pt ${proj_dir}/images/${nmodel}_0/${nmodel}_0_classif.pt
        cp ${proj_dir}/images/baseline/baseline_conf.pt ${proj_dir}/images/${nmodel}_0/${nmodel}_0_conf.pt
        cp ${proj_dir}/images/baseline/baseline_training_loss.csv ${proj_dir}/images/${nmodel}_0/${nmodel}_0_training_loss.csv
        cp ${proj_dir}/images/baseline/labels.csv ${proj_dir}/images/${nmodel}_0/labels.csv
    else
